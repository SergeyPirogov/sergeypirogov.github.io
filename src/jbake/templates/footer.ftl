    <footer class="text-muted page-footer fixed-bottom">
      <div class="container">
            <a class="text-secondary float-right" href="https://docs.google.com/document/d/125Xfq7Rm5kUpQVoAhwUoTPtM-hPgGyMpRCyWwUFpoeA/edit?usp=sharing">Публічна оферта</a>
